...
description: "This is the main M365Advisor command that runs the tests and generates a report of the results."
id: Invoke-M365Advisor
title: Invoke-M365Advisor
hide_title: false
hide_table_of_contents: false
custom_edit_url: https://github.com/m365advisor365/m365advisor/blob/main/powershell/public/Invoke-M365Advisor.ps1
---
...
```powershell
Invoke-M365Advisor [[-Path] <String>] [-Tag <String[]>] [-ExcludeTag <String[]>] [-IncludeLongRunning]
...
[https://m365advisor.dev/docs/commands/Invoke-M365Advisor](https://m365advisor.dev/docs/commands/Invoke-M365Advisor)
