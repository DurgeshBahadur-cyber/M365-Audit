#
# Module manifest for module 'M365Advisor'
#
# Generated by: M365Advisor
#
...
@{
    ...
    FunctionsToExport    = @(
        'Add-MtM365AdvisorAppFederatedCredential', 'Add-MtTestResultDetail', 'Clear-MtDnsCache', 'Clear-MtExoCache',
        'Clear-MtGraphCache', 'Compare-MtJsonObject', 'Compare-MtTestResult', 'Connect-M365Advisor', 'Convert-MtResultsToFlatObject',
        'ConvertFrom-MailAuthenticationRecordDkim', 'ConvertFrom-MailAuthenticationRecordDmarc',
        'ConvertFrom-MailAuthenticationRecordMx', 'ConvertFrom-MailAuthenticationRecordSpf', 'Disconnect-M365Advisor',
        ...
        'Get-MtGraphScope', 'Get-MtGroupMember', 'Get-MtHtmlReport', 'Get-MtLicenseInformation', 'Get-MtM365AdvisorApp', 'Get-MtRegistrableDomain', 'Get-MtRole',
        'Get-MtRoleMember', 'Get-MtSafeMarkdown', 'Get-MtSession', 'Get-MtSpo', 'Get-MtTestInventory', 'Get-MtUser',
        'Get-MtUserAuthenticationMethod', 'Get-MtUserAuthenticationMethodInfoByType', 'Import-MtM365AdvisorResult',
        'Install-M365AdvisorTests', 'Invoke-M365Advisor', 'Invoke-MtAzureRequest', 'Invoke-MtAzureResourceGraphRequest',
        'Invoke-MtGraphRequest', 'Invoke-MtGraphSecurityQuery', 'Merge-MtM365AdvisorResult', 'New-MtM365AdvisorApp', 'Resolve-SPFRecord',
        ...
        'Test-ORCA241', 'Test-ORCA242', 'Test-ORCA243', 'Test-ORCA244', 'Update-M365AdvisorTests', 'Update-MtM365AdvisorApp'
    )
    ...
    AliasesToExport      = @(
        'Invoke-MtM365Advisor',
        'Connect-MtGraph', 'Connect-MtM365Advisor',
