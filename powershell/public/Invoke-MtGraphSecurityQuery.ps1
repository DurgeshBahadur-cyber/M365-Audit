function Invoke-MtGraphSecurityQuery {
    ...
    It simplifies the process of querying and retrieving data from the Microsoft Defender XDR for integration of M365Advisor checks.
    ...
    .LINK
    https://m365advisor.dev/docs/commands/Invoke-MtGraphSecurityQuery
    #>
    [CmdletBinding()]
    param(
        # Valid KQL query
