function Add-MtTestResultDetail {
    ...
    - https://github.com/m365advisor365/m365advisor/blob/main/powershell/public/Test-MtCaEmergencyAccessExists.md
    - https://github.com/m365advisor365/m365advisor/blob/main/powershell/public/Test-MtCaEmergencyAccessExists.ps1
    ...
    .LINK
    https://m365advisor.dev/docs/commands/Add-MtTestResultDetail
    #>
    [CmdletBinding()]
    param(
    ...
    if ($__MtSession -and $__MtSession.TestResultDetail) {
        if (![string]::IsNullOrEmpty($testName)) {
            # Only set if we are running in the context of M365Advisor
