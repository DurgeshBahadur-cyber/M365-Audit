...
custom_edit_url: https://github.com/m365advisor365/m365advisor/blob/main/powershell/public/Get-MtTestInventory.ps1
---
...
$Tags -notmatch 'AzureConfig|CIS|CISA|M365Advisor|MT.\d{4,5}|ORCA'
```
...
```powershell
$TagInventory = Get-MtTestInventory
$TagInventory.Keys -notmatch 'AzureConfig|CIS|CISA|M365Advisor|MT.\d{4,5}|ORCA'
```

foreach ($i in $TagInventory.GetEnumerator()) \{
    if ($i.Key -notmatch 'AzureConfig|CIS|CISA|M365Advisor|MT.\d\{4,5\}|ORCA') \{
        $i
    \}
\}
...
[https://m365advisor.dev/docs/commands/Get-MtTestInventory](https://m365advisor.dev/docs/commands/Get-MtTestInventory)
