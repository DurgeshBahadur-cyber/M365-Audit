...
description: "Direct Send SHOULD be configured to `Reject` in Exchange Online Rationale: Attackers can exploit direct send to send spam or phishing emails without authentication. Direct Send covers anonymous messages (unauthenticated messages) sent from your own domain to your organization's mailboxes using the…"
slug: /tests/MT.1062
...
- PowerShell source: `powershell\public\M365Advisor\exchange\Test-MtExoRejectDirectSend.ps1`
