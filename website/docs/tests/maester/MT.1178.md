...
description: "Ensure at least one Intune Attack Surface Reduction (ASR) policy has rules configured in **Block** or **Audit** mode. ASR rules reduce the attack surface of applications by preventing behaviors commonly abused by malware and threat actors. These rules target specific techniques such as: - **Office…"
slug: /tests/MT.1178
...
| Tags | Intune, M365Advisor, MT.1178 |
...
- PowerShell source: `powershell\public\M365Advisor\intune\Test-MtIntuneASRRules.ps1`
