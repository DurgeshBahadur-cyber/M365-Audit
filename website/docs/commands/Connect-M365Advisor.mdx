...
Connect-M365Advisor [-SendMail] [-SendTeamsMessage] [-Privileged] [-UseDeviceCode] [[-Environment] <String>]
 ...
 [[-Service] <String[]>] [[-TenantId] <String>] [[-GraphClientId] <String>] [[-SharePointClientId] <String>]
 [[-SharePointAdminUrl] <String>] [[-SharePointCertificateThumbprint] <String>]
...
Connects to Microsoft Graph and SharePoint Online using the specified PnP app registration.
...
The services to connect to such as Azure, Dataverse (for Copilot Studio tests), EXO, and SharePoint Online.
Default is Graph.
